...
public class Condominio {
    ...
    @XmlElement(name = "EdificioInteligente")
    ...
    @XmlElement(name = "NumeroTorres")
    protected long numeroTorres;
    @XmlElement(name = "OfficeSpace")
    protected long officeSpace;
    @XmlElement(name = "PermiteAnimais")
    protected long permiteAnimais;
    @XmlElement(name = "PersonalTraining")
    ...
    @XmlElement(name = "QuantidadeElevadores")
    ...
    @XmlElement(name = "ServicosEscritorio")
    ...
    @XmlElement(name = "VestiarioEmpregado")
